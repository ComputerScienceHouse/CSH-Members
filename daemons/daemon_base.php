...
set_include_path(get_include_path() . ':../application/libraries');
set_include_path(get_include_path() . ':../application/controllers');
set_include_path(get_include_path() . ':../external');
